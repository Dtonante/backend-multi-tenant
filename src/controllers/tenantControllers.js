...
export const registerTenant = async (req, res) => {
    ...
    const name_db_tenant = `db_${sanitizedTenantName}`;
    ...
    try {
        ...
        return res.status(201).json({
            ...
            tenant: {
                ...
                email_tenant_admin: `admin@${sanitizedTenantName.toLowerCase()}.com`,
                default_admin_user: `admin@${sanitizedTenantName.toLowerCase()}.com`,
            },
